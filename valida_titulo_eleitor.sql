...
begin
    ...
    if(v_dv = v_dv_cal) then
        return 'Titulo de Eleitor V�lido';
    else
        return 'Titulo de Eleitor Inv�lido';
    end if;
    
EXCEPTION 
   WHEN e_titulo_invalido THEN
   return 'Titulo de eleitor inv�lido. O titulo de eleitor deve conter no maximo 12 d�gitos';
end;
/
